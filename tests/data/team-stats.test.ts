...
describe('loadTeamStats', () => {
  ...
  describe('summary levels', () => {
    it('should load week level by default', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith(
        expect.stringMatching(/stats_team\/stats_team_week_2023\.parquet$/),
        expect.any(Object)
      );
    });
    ...
    it('should load reg level when specified', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith(
        expect.stringMatching(/stats_team\/stats_team_reg_2023\.parquet$/),
        expect.any(Object)
      );
    });
    ...
    it('should map reg+post level to regpost file', async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith(
        expect.stringMatching(/stats_team\/stats_team_regpost_2023\.parquet$/),
        expect.any(Object)
      );
    });
  });
  ...
  describe('format support', () => {
    ...
    it('should load CSV format when specified', async () => {
      ...
      await loadTeamStats(2023, { format: 'csv' });
